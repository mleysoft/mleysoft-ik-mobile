...
echo.
echo [V89] Uyumlu Android JDK kontrol ediliyor...
...
if exist ".mleysoft_v89_android_ready" goto :patch
...
:patch
echo.
echo V89 Android toolchain ayarlari uygulaniyor...
...
> ".mleysoft_v89_android_ready" echo V86
echo Android V89 hazir.
exit /b 0
