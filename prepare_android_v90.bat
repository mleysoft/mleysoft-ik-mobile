...
echo.
echo [V90] Uyumlu Android JDK kontrol ediliyor...
...
if exist ".mleysoft_v90_android_ready" goto :patch
...
:patch
echo.
echo V90 Android toolchain ayarlari uygulaniyor...
...
> ".mleysoft_v90_android_ready" echo V86
echo Android V90 hazir.
exit /b 0
