...
echo.
echo [V88] Uyumlu Android JDK kontrol ediliyor...
...
if exist ".mleysoft_v88_android_ready" goto :patch
...
:patch
echo.
echo V88 Android toolchain ayarlari uygulaniyor...
...
> ".mleysoft_v88_android_ready" echo V86
echo Android V88 hazir.
exit /b 0
