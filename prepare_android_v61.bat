...
echo.
echo [V61] Uyumlu Android JDK kontrol ediliyor...
...
if exist ".mleysoft_v61_android_ready" goto :patch
...
:patch
echo.
echo V61 Android toolchain ayarlari uygulaniyor...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0native_config\configure_android.ps1"
if errorlevel 1 goto :fail

> ".mleysoft_v61_android_ready" echo V58
echo Android V61 hazir.
exit /b 0
