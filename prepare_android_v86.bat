...
echo.
echo [V86] Uyumlu Android JDK kontrol ediliyor...
...
if exist ".mleysoft_v86_android_ready" goto :patch
...
:patch
echo.
echo V86 Android toolchain ayarlari uygulaniyor...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0native_config\configure_android.ps1"
if errorlevel 1 goto :fail

> ".mleysoft_v86_android_ready" echo V86
echo Android V86 hazir.
exit /b 0
