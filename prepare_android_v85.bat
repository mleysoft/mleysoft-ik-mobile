...
echo.
echo [V85] Uyumlu Android JDK kontrol ediliyor...
...
if exist ".mleysoft_v85_android_ready" goto :patch
...
:patch
echo.
echo V85 Android toolchain ayarlari uygulaniyor...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0native_config\configure_android.ps1"
if errorlevel 1 goto :fail

> ".mleysoft_v85_android_ready" echo V85
echo Android V85 hazir.
exit /b 0
