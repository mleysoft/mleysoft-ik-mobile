...
echo.
echo [V98] Uyumlu Android JDK kontrol ediliyor...
...
if exist ".mleysoft_v98_android_ready" goto :patch
...
:patch
echo.
echo V98 Android toolchain ayarlari uygulaniyor...
...
> ".mleysoft_v98_android_ready" echo V98
echo Android V98 hazir.
exit /b 0
