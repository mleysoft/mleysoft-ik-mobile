...
echo.
echo [V84] Uyumlu Android JDK kontrol ediliyor...
...
if exist ".mleysoft_v84_android_ready" goto :patch
...
:patch
echo.
echo V84 Android toolchain ayarlari uygulaniyor...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0native_config\configure_android.ps1"
if errorlevel 1 goto :fail

> ".mleysoft_v84_android_ready" echo V84
echo Android V84 hazir.
exit /b 0
