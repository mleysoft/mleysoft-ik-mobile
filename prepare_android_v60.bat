...
echo.
echo [V60] Uyumlu Android JDK kontrol ediliyor...
...
if exist ".mleysoft_v60_android_ready" goto :patch
...
:patch
echo.
echo V60 Android toolchain ayarlari uygulaniyor...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0native_config\configure_android.ps1"
if errorlevel 1 goto :fail

> ".mleysoft_v60_android_ready" echo V58
echo Android V60 hazir.
exit /b 0
