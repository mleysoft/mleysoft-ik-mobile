...
echo.
echo [V82] Uyumlu Android JDK kontrol ediliyor...
...
if exist ".mleysoft_v82_android_ready" goto :patch
...
:patch
echo.
echo V82 Android toolchain ayarlari uygulaniyor...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0native_config\configure_android.ps1"
if errorlevel 1 goto :fail

> ".mleysoft_v82_android_ready" echo V82
echo Android V82 hazir.
exit /b 0
