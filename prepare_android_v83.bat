...
echo.
echo [V83] Uyumlu Android JDK kontrol ediliyor...
...
if exist ".mleysoft_v83_android_ready" goto :patch
...
:patch
echo.
echo V83 Android toolchain ayarlari uygulaniyor...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0native_config\configure_android.ps1"
if errorlevel 1 goto :fail

> ".mleysoft_v83_android_ready" echo V83
echo Android V83 hazir.
exit /b 0
